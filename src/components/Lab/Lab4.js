            ...
            <div className="container" style={{marginTop: '150px'}}><div className="row mb-5">
                <div className="col-md-12"><div className="card pb-3"><div className="card-header">
                      <ul className="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li className="nav-item"><a className="nav-link active" href="/Lab4">Lab 4</a></li>
                        <li className="nav-item"><a className="nav-link" href="/Lab5">Lab 5</a></li>
                      </ul>
                     </div>

<div className="tab-pane active" id="lab4">
    <div className="card-header mb-4">
    <ul className="nav nav-tabs card-header-tabs" role="tablist">
        <li className="nav-item">
            <a id="r" className="nav-link " data-toggle="tab" href="#requirement">Requirement</a></li>
        <li className="nav-item">
            <a className="nav-link " data-toggle="tab" href="#design">Design</a></li>
        <li className="nav-item">
            <a className="nav-link" data-toggle="tab" href="#implement">Implement</a></li>
    </ul></div>
    <div className="tab-content">
        <div className="tab-pane active" id="requirement">
            <div className="container">
                <h2>Yêu cầu: </h2><p>- Tạo một trang Web có nội dung bất kỳ, sử dụng linh hoạt tất cả những phần sau: Input Controls, Navigation, Animations, Default Settings, Guided Actions</p><p>- Có biểu mẫu liên hệ</p></div></div>
        ...
        <div className="row m-3">
            <img className="img-fluid" src="assets\img\Lab\Lab4.jpg" alt="Design on paper" /></div>
        <div className="row justify-content-center">
            <a href="assets\img\Lab\Lab4.jpg" className="text-decoration-none" download="Lab4.jpg">
            <button type="button" className="btn btn-info ">Download</button></a></div></div>
            </div>
              </div></div>
              <div className="tab-pane active" id="implement">
                        <div id="banner">
          <div className="container" id="cloud-scroll">
                  <nav className="navbar navbar-expand-sm bg-info navbar-dark row">
            <div className="col-md-2">
              <a className="navbar-brand" href="#"> NHL Shop</a></div>
       <div className="col-md-6"><ul className="navbar-nav">
      <li className="nav-item "><a className="nav-link active" href="#">Home</a></li>
         <li className="nav-item"><a className="nav-link " href="#">About</a></li>
        <li className="nav-item dropdown">
             <a className="nav-link " href="#" id="navbardrop" data-toggle="dropdown">Shop</a>
     </li>
            <li className="nav-item">
                 <a className="nav-link " href="#">Contact</a></li>
                     ...
                     <button className="btn btn-success">Search</button></div></nav>
         ...
         <form>
            <div className="form-group"><label className=" control-label col-sm-5">Username:</label>
             <div className="col-sm-10"><input type="email" className="form-control" placeholder="Enter username" /></div></div>
             <div className="form-group"><label className="control-label col-sm-5">Password:</label>
          <div className="col-sm-10"><input type="password" className="form-control" placeholder="Enter password" /></div></div>
             <div className="form-group"><label className="control-label col-sm-5">Confirm Password:</label>
             <div className="col-sm-10"><input type="password" className="form-control" placeholder="Confirm password" /></div></div>
             <div className="form-group"><label className="control-label col-sm-5">Sex:</label>
         <div className="col-sm-10"><select className="form-control" id="sel1"><option>Male</option><option>Female</option></select></div></div>
             <div className="form-group"><label className="control-label col-sm-5">Address:</label>
             <div className="col-sm-10"><textarea className="form-control" rows={3} placeholder="Your address" defaultValue={""} /></div></div>
             <div className="form-group">
               <div className="col-sm-offset-2 col-sm-10 text-center">
              <button className="btn btn-success">Submit</button></div></div>
        </form>
