         ...
         <div id="root">
            ...
            <div className="tab-content">
                <div className="tab-pane active" role="tabpanel" id="">
                     <div className="container">
                               <h2>Yêu cầu: </h2><p>1/ Tạo ra một user scenario </p><p>2/ Chọn 1 bước trong user scenario để thiết kế 1 form giao diện Web trên công cụ thiết kế đã chọn. Sau đó tạo ra file JS tương ứng cho thiết kế này</p><hr /><p>Upload lên Firebase: trong file JS có chèn hình ảnh của user scenario ở (1) và đường dẫn của file thiết kế ở (2)</p></div></div>
                               <h3>=========================================================</h3>
                               <div className="tab-pane active"id="user-scenario" role="tabpanel"  aria-labelledby="1">
                      <div className="container">
                         <div className="row">
                 <p className="m-2 font-weight-bold">Với tình trạng dịch hiện nay thì việc khai báo y tế là hết sức quan trọng.</p></div>
                 <p>Cùng chung tay góp sức phòng chống dịch</p>
                 ...
                 <div className="tab-pane active"role="tabpanel" id="implement">
                     <div className="container">
                                  <div className="row justify-content-center mb-4 ml-2 mt-2">
                                     <h3>Nhập thông tin cho phần khai báo y tế:</h3></div>
                          <div className="row justify-content-center mb-4">
                                 <div className="col-lg-5 col-md-6 col-xs-10 col-sm-9 border">
                             <div className="row justify-content-center mb-4 bg-dark">
                            <h3 className="text-center text-white">Khai báo y tế</h3></div>
                            <div className="row justify-content-center">
                                <table className="table table-borderless text-left">
                                    <tbody><tr><td>Họ tên: </td><td><input type="text" style={{width: '200px'}} placeholder="Nhập tên" /></td></tr>
                                    <tr><td>Ngày sinh: </td><td><input type="text" style={{width: '200px'}} placeholder="Nhập dd/mm/yyyy" /></td></tr>
                                    <tr><td>Số điện thoại:</td><td><input type="text" style={{width: '200px'}} placeholder="Nhập số điện thoại" /></td></tr><tr /><tr><td>Tỉnh/Thành phố:</td><td><select placeholder="a" style={{width: '200px'}}>
                  <option value disabled>Chọn Tỉnh/Thành</option >
                  <option>Hồ Chí Minh</option>
                  <option>Hà Nội</option>
                  <option>Đà Nẵng</option>
                 <option>Đồng Nai</option>
                 </select></td></tr><tr><td>Quận/Huyện</td><td><select placeholder="a" style={{width: '200px'}}><option value disabled>Chọn Quận/Huyện</option>
                  <option>Quận 1</option>
                  <option>Quận 2</option>
                  <option>Quận 3</option>
                  <option>Quận 4</option></select></td></tr><tr><td>Phường/Xã</td><td><select placeholder="a" style={{width: '200px'}}>
                      <option value disabled>Chọn Phường/Xã</option>
                      <option>Phường An Bình</option>
                      <option>Phường An Phú</option>
                      <option>Phường Bình Khánh</option>
                      <option>Phường Bình Tây</option>
                      </select></td></tr><tr><td>Lộ trình đã đi</td><td><textarea className="form-control" rows={3} placeholder="Lộ trình" defaultValue={""} /></td></tr><tr><td colSpan={2} className="text-center">
                      <button type="button" className="btn btn-info">Khai báo</button></td></tr>
